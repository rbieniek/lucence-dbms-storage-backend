...
public class LucenceService implements InitializingBean, DisposableBean {
	...
	public void indexLogstoreRecord(final LogstoreRecord record) throws IOException {
	...
	public Set<Long> searchLogstoreRecords(final Set<String> searchTerms, final int searchLimit) throws IOException {
