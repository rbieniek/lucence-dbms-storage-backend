...
@SpringBootTest(webEnvironment = WebEnvironment.NONE, classes = JdbcFileManagerIntegrationTest.TestConfig.class, properties = "spring.datasource.url=jdbc:h2:mem:JFMIT;DB_CLOSE_ON_EXIT=FALSE")
