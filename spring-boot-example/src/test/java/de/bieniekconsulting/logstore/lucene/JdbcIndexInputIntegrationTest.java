...
@SpringBootTest(webEnvironment = WebEnvironment.NONE, classes = JdbcIndexInputIntegrationTest.TestConfig.class, properties = "spring.datasource.url=jdbc:h2:mem:JIIIT;DB_CLOSE_ON_EXIT=FALSE")
