...
@SpringBootTest(webEnvironment = WebEnvironment.NONE, classes = LuceneSearchIntegrationTest.TestConfig.class, properties = "spring.datasource.url=jdbc:h2:mem:LSIT1;DB_CLOSE_ON_EXIT=FALSE")
